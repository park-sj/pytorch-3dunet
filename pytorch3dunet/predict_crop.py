'''
To predict bone or airway mask, use this code.

Necessary arguments : config file, CT to predict, crop range
You can designate them by calling this code with argument,
or just run it without argument and follow the instruction
'''
