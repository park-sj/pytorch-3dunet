...
class DicomTestDataset(ConfigDataset):
    ...
    def getImage(self, count):
        ...
        self.cur_image = self._load_files(os.path.join(self.file_path, self.patients[count]))

        # The input arguments are dummy values
